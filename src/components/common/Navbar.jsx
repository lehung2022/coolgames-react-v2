...
import { BsPlaystation, BsFacebook, BsTwitter, BsYoutube} from "react-icons/bs";
          ...
          <div className={`navbar-collapse ${sidebarStatus ? "show" : " "}`}>
            ...
            <ul className='connect-list d-flex justify-content-center align-items-center mt-5 flex-wrap'>
              ...
              <li className='connect-item'>
                <Link to = "https://www.playstation.com/en-us/" className='connect-link'>
                  <BsPlaystation />
                </Link>
              </li>
              <li className='connect-item'>
                <Link to = "https://www.facebook.com/profile.php?id=61560868992749" className='connect-link'>
                  <BsFacebook size = { 18 } />
                </Link>
              </li>
              <li className='connect-item'>
                <Link to = "https://x.com/lngm1916" className='connect-link'>
                  <BsTwitter size = { 18 } />
                </Link>
              </li>
              <li className='connect-item'>
                <Link to = "https://www.youtube.com/@hunggamerofficial3252" className='connect-link'>
                  <BsYoutube size = { 19 } />
                </Link>
              </li>
            </ul>
